...
[1.0.9(27) UI 상호작용 변경 기록](docs/UI_INTERACTION_1.0.9_27.md)에 iPad Watch Ad 버튼의 고정 곡률, 사진 불러오기 버튼의 44×44 유효 터치 영역과 첫 탭 처리, 공통 설정 슬라이더의 실시간 드래그·반응형 폭 개선을 기록했습니다. Settings는 V1.0.9를 표시합니다. 이 변경은 기존 1.0.8(26) Android 산출물 이후의 소스이며, 새 빌드·실기기 검증은 아직 실행하지 않았습니다.
