...
- 최근 기록된 로컬 APK/AAB는 **1.1.2 (30)**, 소스 `a49fed6e711156b841a486528dc63241baae414c`, 실행 ID `20260922-003235-4e1bd97d`입니다. 30은 빌드 시 명시한 override입니다. 고정 빌드 폴더·기존 서명·production AdMob으로 생성했으며 전체 래퍼 시간은 492.82초(약 8분 13초)입니다. [실행 기록](artifacts/apk-runs/20260922-003235-4e1bd97d/build-result.json)과 [기존 Android 빌드 이력](docs/ANDROID_BUILD_OPTIMIZATION.md)을 참고하세요. 설치 APK 해시도 이 산출물과 일치했습니다. 후속 접근성 수정과 이번 미사용 export 정리는 아직 이 APK/AAB에 포함되지 않았습니다.
