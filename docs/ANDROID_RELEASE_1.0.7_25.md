...
## 2026-09-11 네비게이션 바 수정 포함 재빌드

**compile-ok**. 이전 AAB 미업로드 확인에 따라 1.0.7(25)를 유지했습니다. 최신 제출본은 `artifacts/apk-runs/20260911-000341-2ec246e8`이며, 소스는 main `ef29c7c`입니다. 별도 스플래시 수정 제외, 네이티브 SystemChrome 호출의 실제 번들 포함을 확인했습니다. 이전 산출물은 보존합니다.

의존성 설치·네이티브 재생성 없이 Gradle 4분 24초, 75 executed / 0 FROM-CACHE / 1128 UP-TO-DATE. 기록 생성부터 빌드 결과 기록까지 292.4초입니다. APK25/AAB20 검사와 기존 서명·실제 광고·API36·Billing9.1·4ABI·16KB·동일 매핑/DEX/네이티브/Hermes 검증 통과. 실제 기기에서 수정 후 네비게이션 바 미노출은 아직 미검증이며 Play 업로드·매핑 등록도 미실행입니다.

APK SHA256: `e874644d5d0fe7199b3b43ce2fc261ea06535a6dd3bab662fc9fa85090ba28f4`

AAB SHA256: `7d54a1dce07bd460e3a72c03bca5247e2ea84092d4994fc06baf370f77531b10`

상세 경고·증빙·매핑과 심볼은 해당 빌드 폴더의 BUILD.md 및 검증 기록에 보존했습니다.
